...
char *s21_strchr(const char *data, int p);
...
double s21_strtod(const char *start, char **end);
float s21_strtof(const char *start, char **end);
long double s21_strtold(const char *start, char **end);
